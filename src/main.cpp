...
int main() {
	...
	try {
        ...
        glm::mat4 water_bottle_m_matrix = glm::translate(glm::vec3(0.0f, -1.0f, 3.0f));
        ...
        glm::mat4 table_m_matrix = glm::translate(glm::vec3(0.5f, -0.35f, 2.0f))*glm::rotate(glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f))
